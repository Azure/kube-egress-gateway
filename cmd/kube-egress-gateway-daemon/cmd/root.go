...
func init() {
	...
	rootCmd.Flags().IntVar(&lbProbeDrainDelaySeconds, "lb-probe-drain-delay-seconds", 10, "Seconds to wait after marking LB probe unhealthy before shutting down (allows LB to drain traffic).")
