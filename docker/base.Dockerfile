...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.5@sha256:4168df9b33b82cf4aa1e9fa90080a8cd488428c0e0ba804096bc5a1cde6052c2 AS builder 
WORKDIR /workspace
