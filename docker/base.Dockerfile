...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.2@sha256:4920c4d639d6cd98d2791c262705da0475b84e866ee131394e0df3caf75ddc23 AS builder 
WORKDIR /workspace
