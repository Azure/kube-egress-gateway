...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.2@sha256:9f0d69666676998a1977ce1a6d0a5c96b3df8f30bf465ac4f6bd64bd50fb520c AS builder 
WORKDIR /workspace
