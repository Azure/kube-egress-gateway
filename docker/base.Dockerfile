...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.8@sha256:d080d8acfa6bbe4fb1713576f83782a04f2783336a89e032679fee7c5e4f1d7c AS builder 
WORKDIR /workspace
