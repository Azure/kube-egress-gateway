...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.1@sha256:941a7114d159d00f3e4f9356e171fb325768b37ed6cb0103a739a88195b694ad AS builder 
WORKDIR /workspace
