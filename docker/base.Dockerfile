...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.5@sha256:e15af988b54ee03e8ce4496c77ff736c109563595c42bc847e9366111be36d4c AS builder 
WORKDIR /workspace
