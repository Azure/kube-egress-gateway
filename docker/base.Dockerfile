...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.3@sha256:94537ee150f18ba94f09ef1871780c4b9f9acb624fac2a68abedd2d1057c4272 AS builder 
WORKDIR /workspace
