...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.2@sha256:57529e2747164a583f3d1b86239a0e75bf38c79446504ad6a42c6ea671499bfa AS builder 
WORKDIR /workspace
