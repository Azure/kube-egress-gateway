...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.2@sha256:dd17a9606e72e43a267beb534e6162a78ab29e38a2b1cad435066516b0cebb88 AS builder 
WORKDIR /workspace
