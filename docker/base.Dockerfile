...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.1@sha256:e05ea9c54d7e519c40fdebbf1a7bb60dbe9b8cf5210073d4c1c13b4f74aa4724 AS builder 
WORKDIR /workspace
