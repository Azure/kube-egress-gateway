...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.5@sha256:36c201c0d2e42fe5b63e83dcc72c0751e08c45d89dc26d46eda75065485a9152 AS builder 
WORKDIR /workspace
