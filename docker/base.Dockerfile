...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.5@sha256:402b87fbbfaaa34ca863acb41479665a98e71bba3656be25046b25d720c062af AS builder 
WORKDIR /workspace
