...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.3@sha256:cf5841455bd82a4cad3928b55672f6308a78d34a3b531e263523d68724779fb9 AS builder 
WORKDIR /workspace
