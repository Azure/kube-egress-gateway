...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.3@sha256:512d702dbdbc99abc623cccd2b12638995fdfea8f44893dadf33da991e20ebbd AS builder 
WORKDIR /workspace
