...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.3@sha256:3ca204a4606a7596aa67183f74d34e4f3ec4f150719d02999e2201fd635ebe96 AS builder 
WORKDIR /workspace
