...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.4@sha256:8ab3baf7a893d61fcf362889fd080c479989e8496cd0465b34bf0428100971a2 AS builder 
WORKDIR /workspace
