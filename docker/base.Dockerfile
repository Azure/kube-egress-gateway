...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.2@sha256:497ecd3bbeda0819195ca791f687c1a9011d7630113a39ec09eeb511ae9dee9a AS builder 
WORKDIR /workspace
