...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.3@sha256:3fe31f26260e566cf2f48c8dc150187420cce08f592bde895597665435f9a66f AS builder 
WORKDIR /workspace
