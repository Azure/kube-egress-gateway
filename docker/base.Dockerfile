...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.4@sha256:a0c0c8232848dab4eebf17082841704317e5bda693155b93624115f907383c94 AS builder 
WORKDIR /workspace
