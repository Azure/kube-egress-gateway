...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.2@sha256:2bb32ed22948488d8639fb0abf6848585f0981fb88fed7492bb23aefb4c46d0b AS builder 
WORKDIR /workspace
