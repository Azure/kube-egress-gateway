...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.4@sha256:28775847d60017567a97c733eafe4f3de8eea1afaa01640f952d2850f03c9127 AS builder 
WORKDIR /workspace
