...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.6@sha256:db9233e112bb9ce280ab7c777e7a7f73a4c58b51cf5f5aa08f98e24bce590360 AS builder 
WORKDIR /workspace
