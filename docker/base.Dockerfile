...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.7@sha256:cc985215fb5941b9da3a8e518b121fb3459b90a16598aab494e316d77a73090b AS builder 
WORKDIR /workspace
