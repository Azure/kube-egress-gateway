...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.1@sha256:962c0bcb6347c7dc0bf2a7001dbdb14b0c4a01196d90206fc9bc99dc9a3a6291 AS builder 
WORKDIR /workspace
