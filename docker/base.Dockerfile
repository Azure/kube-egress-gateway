...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.4@sha256:94b1688200aa17ae535f0435bfad4dc692498a942a0be2abf74434487b0ea4f4 AS builder 
WORKDIR /workspace
