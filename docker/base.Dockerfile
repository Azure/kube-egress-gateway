...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.3@sha256:78fcc4c44f4719fb4714bf1abbb980064b916ff4aa1ee5db15a54a3bd1ed8412 AS builder 
WORKDIR /workspace
