...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.3@sha256:7e69174761ff7fe6f71bb2adf9754b7741af7b8467bd4ba2e465b88a9f872be1 AS builder 
WORKDIR /workspace
