...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.24.4@sha256:c57c50ffe7a962999136a0e63fa14af798a32569e60a8c9ea4e18681d553878c AS builder 
WORKDIR /workspace
