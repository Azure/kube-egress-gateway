...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.7@sha256:721562f7c43430e91ffaa04a425df3523ac4f0c23458a164453edeaf5c884b45 AS builder 
WORKDIR /workspace
