...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.4@sha256:5ff8cf3f409bd3a6c152148da27dd9ba63a9e24c1f89f6a6abf69424435b10ee AS builder 
WORKDIR /workspace
