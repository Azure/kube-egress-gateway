...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.23.9@sha256:dec395683f52e5407f5a3c48ff9d9efb4e28464bbf3c826a2ce0d0133fad9fab AS builder 
WORKDIR /workspace
