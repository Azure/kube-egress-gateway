...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.3@sha256:539061bf9b2abe129fec43505a566b6be93bc17e813eb6369992456f8914eeb3 AS builder 
WORKDIR /workspace
