...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/oss/go/microsoft/golang:1.25.5@sha256:c274fbe98484ccdce5ea7eeaac84db433c2a2c139f5fc817f4e48a4e615c3c95 AS builder 
WORKDIR /workspace
